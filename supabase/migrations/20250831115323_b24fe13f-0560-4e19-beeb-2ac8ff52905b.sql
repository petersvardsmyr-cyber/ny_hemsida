-- Insert blog posts from 2022

INSERT INTO blog_posts (id, title, slug, content, excerpt, author, published_date, featured_image_url, is_published, created_at, updated_at) VALUES

-- Varför ta isbad? (2022-12-28)
('01924470-f1a5-7000-8000-123456789007', 
'Varför ta isbad?', 
'varfor-ta-isbad', 
'_**Det finns en sak med iskalla bad på vintern som är hela grejen för mig. Visst, hälsofördelar som är rent fysiologiska i all ära, men kallbad handlar om något annat för mig.**_

Att ta ett isbad, kallbad eller vinterbad eller vad man nu kallar det för handlar om uppståndelse.

Ja, visst låter det dramatiskt. Och det är faktiskt ganska dramatiskt.

Minuterna innan någon tar sina första isbad i livet är det kanske svårt att tro att man kommer klara det. Varenda liten cell i kroppen säger till dig att du inte borde. Det är livsfarligt. Gör det inte!!

Och det är ju sant. Till viss del. För iskalla bad är livsfarligt, om man skulle stanna där länge. Det vet kroppen. Det är en farlig miljö för oss.

Men det vi gör när vi kallbadar på vintern är något annat än att skada oss själva. Vi utsätter oss inte för livsfara, bara en enorm stress, under en kort stund. Och det är inte farligt utan precis tvärtom. Att utsätta kroppen för kortvarig stress är nyttigt. Precis som vilket träningspass som helst. Det bygger upp fysiskt motstånd och mental styrka och en förståelse att livet är hanterbart, oavsett vad som händer.

Så, isbad är det mest effektiva sättet att berätta för hela min existens att jag faktiskt lever. Det är vad jag upptäckt. Jag trodde jag skulle dö, men jag lever. En slags kontrollerad död och uppståndelse.
...
Ha en fin dag! /p', 
'Det finns en sak med iskalla bad på vintern som är hela grejen för mig - det handlar om uppståndelse.',
'Peter Svärdsmyr',
'2022-12-28',
'https://i0.wp.com/petersvardsmyr.se/wp-content/uploads/2022/12/pexels-photo-300857.jpeg?fit=1880%2C1253&ssl=1',
true,
now(),
now()),

-- BeReal – appen som håller på att förändra allt (2022-11-17)
('01924470-f1a5-7000-8000-123456789008',
'BeReal – appen som håller på att förändra allt',
'bereal-appen-som-haller-pa-att-forandra-allt',
...
_Så, vad är det som händer här?_
...
_Men, vad är BeReal då? Vad har de som inte andra appar har?_
...
'Den unga generationen visar vägen bort från perfekta selfies. BeReal har över 15 miljoner användare och rankat nr 1.',
'Peter Svärdsmyr',
'2022-11-17',
'https://i0.wp.com/petersvardsmyr.se/wp-content/uploads/2022/11/pokemon-pokemon-go-phone-game-159395.jpeg?fit=1667%2C1300&ssl=1',
true,
now(),
now()),

-- Skriva för att förstå (tankar från Bokmässan) (2022-09-22)
('01924470-f1a5-7000-8000-123456789009',
'Skriva för att förstå (tankar från Bokmässan)',
'skriva-for-att-forsta-tankar-fran-bokmassan',
...
En av hans deviser är – _Read to collect, write to connect._
...
'Vi lär bäst när vi skriver, snarare än när vi läser. Read to collect, write to connect.',
'Peter Svärdsmyr',
'2022-09-22',
'https://i0.wp.com/petersvardsmyr.se/wp-content/uploads/2022/09/IMG_9008-scaled.jpg?fit=2560%2C1920&ssl=1',
true,
now(),
now()),

-- Storm på livets skepp (2022-09-16)
('01924470-f1a5-7000-8000-123456789010',
'Storm på livets skepp',
'storm-pa-livets-skepp',
'Du kanske är där.
...
'Mitt i livets storm är du kapten på ditt skepp. Håll fast i rodret - stormen kommer att gå över.',
'Peter Svärdsmyr',
'2022-09-16',
'https://i0.wp.com/petersvardsmyr.se/wp-content/uploads/2022/09/pexels-photo-826388.jpeg?fit=1880%2C1058&ssl=1',
true,
now(),
now()),

-- 3 saker jag lärt mig som pappa (2022-08-04)
('01924470-f1a5-7000-8000-123456789011',
'3 saker jag lärt mig som pappa',
'3-saker-jag-lart-mig-som-pappa',
...
/p',
'Tre saker jag lärt mig som pappa: Lättare att säga nej, bättre impulskontroll och värdera min egentid.',
'Peter Svärdsmyr',
'2022-08-04',
'https://i0.wp.com/petersvardsmyr.se/wp-content/uploads/2022/08/pexels-photo-69096.jpeg?fit=1880%2C1253&ssl=1',
true,
now(),
now());