          ...
          <div className="mb-16">
            <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6 md:mb-8">Jag är en person som älskar att skriva och skapa. Så länge jag kommer ihåg har jag varit fascinerad möjligheterna i världen omkring mig. Språket, musiken och konsten har fångat mig mest, men även pedagogik, utbildning och entreprenörsskap. Jag är utbildad beteendevetare och församlingspedagog. Till vardags arbetar jag som stiftspedagog i Skara stift med kompetensutveckling, rekrytering och utvecklingsarbete.<br /><br />
      ...
      <section id="writing" className="py-12 md:py-20 px-4 md:px-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute -top-4 right-8 md:right-16 w-48 h-48 md:w-64 md:h-64" viewBox="0 0 200 200" fill="none">
            <path d="M180 20 Q140 60 100 80 Q60 100 40 160" stroke="hsl(var(--muted-foreground))" strokeWidth="1.5" strokeLinecap="round" opacity="0.12" fill="none" />
            <path d="M170 30 Q130 70 95 90" stroke="hsl(var(--muted-foreground))" strokeWidth="1" strokeLinecap="round" opacity="0.08" fill="none" />
          </svg>
          ...
          <svg className="absolute top-1/3 -right-8 md:right-4 w-64 h-40 md:w-80 md:h-48" viewBox="0 0 300 150" fill="none">
            {/* First cursive line */}
            <path d="M20 30 Q35 20 50 30 Q65 40 80 30 Q100 15 120 30 Q135 42 150 32 Q170 18 190 30 Q210 42 230 28 Q250 15 270 30" stroke="hsl(var(--muted-foreground))" strokeWidth="1" strokeLinecap="round" opacity="0.1" fill="none" />
            {/* Second cursive line */}
            <path d="M30 60 Q50 48 70 58 Q90 68 110 55 Q130 42 155 58 Q175 72 195 55 Q220 38 245 58" stroke="hsl(var(--muted-foreground))" strokeWidth="0.8" strokeLinecap="round" opacity="0.08" fill="none" />
            {/* Third cursive line - shorter */}
            <path d="M50 90 Q70 78 90 88 Q115 100 140 85 Q160 72 185 88" stroke="hsl(var(--muted-foreground))" strokeWidth="0.6" strokeLinecap="round" opacity="0.06" fill="none" />
          </svg>
          ...
          <svg className="absolute -bottom-8 -left-4 w-56 h-56 md:w-72 md:h-72" viewBox="0 0 200 200" fill="none">
            <path d="M20 180 C40 140 70 120 100 110 C140 95 160 70 175 30" stroke="hsl(var(--muted-foreground))" strokeWidth="1.5" strokeLinecap="round" opacity="0.1" fill="none" />
          ...
          <svg className="absolute bottom-8 left-1/4 w-48 h-24 md:w-64 md:h-32" viewBox="0 0 200 80" fill="none">
            <path d="M10 50 Q30 30 50 45 C70 60 80 25 100 40 Q120 55 140 35 C155 20 170 45 190 30" stroke="hsl(var(--muted-foreground))" strokeWidth="0.8" strokeLinecap="round" opacity="0.09" fill="none" />
            {/* Small decorative loop */}
            <path d="M85 42 Q90 30 95 42" stroke="hsl(var(--muted-foreground))" strokeWidth="0.6" strokeLinecap="round" opacity="0.07" fill="none" />
          </svg>
