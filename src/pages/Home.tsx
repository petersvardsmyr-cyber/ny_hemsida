...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col justify-start pt-20">
      {/* About Section */}
      <section id="about" className="min-h-screen py-20 px-12 flex items-center">
        <div className="max-w-4xl">
          <div className="mb-16">
            ...
            <div className="flex gap-4">
              <a 
                href="#" 
                className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-muted hover:bg-accent hover:text-accent-foreground transition-colors"
