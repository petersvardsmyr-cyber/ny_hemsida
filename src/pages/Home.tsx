          ...
          <div className="mb-16">
            <div className="flex items-start gap-6 md:gap-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6 md:mb-8">Det finns en rytm i allt. När jag skriver tänker jag på rytm, mer än på exakt innehåll. Självklart ska det vara rätt innehåll, men om rytmen inte finns där kommer ändå ingen att förstår vad jag vill säga. 
                <br /><br />
